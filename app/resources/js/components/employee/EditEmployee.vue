<template>
    <div>
        <h3 class="text-center">Редактирование сотрудника</h3>
        <div class="row">
            <div class="col-md-6">
...
export default {
    ...
    created() {
        this.getDepartments();
        this.axios
            .get(process.env.VUE_APP_API_URL + `employee/${this.$route.params.id}`)
            .then((res) => {
    ...
    methods: {
        editEmployee() {
            this.axios
                .patch(process.env.VUE_APP_API_URL + `employee/${this.$route.params.id}`, this.employee)
                .then((res) => {
